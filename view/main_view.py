...
def fill_information_event(gui_controler, selected_event_type):
    ...
    if selected_event_type == 'Bar':
        ...
        gui_controler.gestion_controler.gestion_controler.create_event(selected_event_type,artist_name,event_name,event_place,event_date,opening_event_time,direccion_event,event_city,artist_payment)
    elif selected_event_type == 'Theater':
        alquiler_price = "aqui va un input"
        gui_controler.gestion_controler.gestion_controler.create_event(selected_event_type,artist_name,event_name,event_place,event_date,opening_event_time,direccion_event,event_city,alquiler_price)
    else:
        sponsor_name = "aqui va un input"
        sponsor_help = "aqui va un input"
        gui_controler.gestion_controler.gestion_controler.create_event(selected_event_type,artist_name,event_name,event_place,event_date,opening_event_time,direccion_event,event_city,None)
    ...
    if selected_event_type != 'Philanthropic':
        ...
        st.button(on_click=gui_controler.gestion_controler.gestion_controler.set_category_ticket(event_name,category_ticket_name,category_ticket_value))
